...
export default function ComingSoonProductDetails() {
    const sneakername = localStorage.getItem("productnameupcoming");
    const sneakerimage = localStorage.getItem("productimageupcoming");
    const sneakerprice = localStorage.getItem("productpriceupcoming");
    const sneakertype = localStorage.getItem("producttypeupcoming");
    const sneakerid = localStorage.getItem("PIDupcoming");

    const [productdetails, setProductDetails] = useState('');
    const [filteredSizes, setFilteredSizes] = useState([]);

    useEffect(() => {
        document.title = `Prebook ${sneakername} | LuxeLayers`;
    }, [sneakername]);
